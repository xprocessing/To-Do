...
<body>
	<div class="To-Do-Lists-ALL">
		<div id="timeisall" title="双击这里保存修改">
		...
		foreach ( $ToDoLists as $ToDoList ) {
			...
			foreach ( $ToDoList->childNodes as $ToDoListchildNode ) {
				...
				if ( $ToDoListchildNode->nodeName == 'To-Do-Big' ) {
					...
					echo '<div class="To-Do-List"><div class="To-Do-Big">';
					echo $ToDoListchildNode->nodeValue;
					echo '</div><div class="To-Do-small"><ul>';
		...
		?>
		<img src="23T-yellow.jpg" width="100%" id="Mustang">
	</div>
	...
	<script>
		$( document ).ready( function () {
			...
			$( ".To-Do-small" ).delay(10000).fadeToggle();
			...
			$( "body" ).on( "dblclick", "#Mustang", function () {
				...
				$( ".To-Do-List" ).each( function () {
					...
					var ToDoBig = $( this ).find( ".To-Do-Big" ).text();
					newToDoxml = newToDoxml + '<To-Do-List><To-Do-Big>' + ToDoBig + '</To-Do-Big><To-Do-small>';
					...
					$( this ).find( "li" ).each( function () {
						...
						if ( $( this ).find( "input" ).is( ':checked' ) ) {
							var ToDosmallli = $( this ).find( "span" ).text();
